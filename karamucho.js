const item = [
    {
        ...
        taste: "Vị cay đặc biệt (25g) - (44g) - (80gr)",
        energy: "558",
        calories: "315",
        caloriesPercent: "54%",
        totalFat: "35.0g",
    ...
    // },
    {
        ...
        description: [
            "Đậm đà vị rong biển Nhật Bản",
            "Sự pha trộn tuyệt vời giữa các hương vị cay – chua - ngọt",
        ],
        title: "Snack khoai tây Karamucho Strong Lát dày",
    ...
    // },
    {
        ...
        firstName: "",
        lastName: "",
        fullName: "SNACK KHOAI TÂY KARAMUCHO - VỊ KHÔ BÒ",
        description: "",
        title: "Snack khoai tây Karamucho",
        taste: "Vị khô bò (25g) - (44g) - (80g)",
        energy: "",
        calories: "",
        caloriesPercent: "",
        totalFat: "",
    ...
    },
    {
        ...
        firstName: "",
        lastName: "",
        fullName: "SNACK KHOAI TÂY KARAMUCHO - VỊ SỐT CAY NGỌT",
        description: "",
        title: "Snack khoai tây Karamucho",
        taste: "Vị sốt cay ngọt (25g) - (44g) - (80g)",
        energy: "",
        calories: "",
        caloriesPercent: "",
        totalFat: "",
    ...
    $(".item").click(function () {
        ...
        switch (this.id) {
            ...
            case "item6":
                ...
                $(".item-title-bot").text(item[5].title);
            ...
            case "item7":
                ...
                $(".item-title-bot").text(item[6].title);
            ...
            case "item8":
                ...
                $(".item-title-bot").text(item[7].title);
...
$(document).ready(function () {
    ...
    function updateLanguage(language) {
        if (language === "vi") {
            ...
            // Menu dialog
            $(".navbar-content_wrap .nav-content_item:nth-child(1) a").text("Trang Chủ")
            $(".navbar-content_wrap .nav-content_item:nth-child(2) a").text("Website Công Ty")
            ...
            $(".navbar-content_wrap .nav-content_item:nth-child(2) a").text("Corporate Site")
        }
    }
