const item = [
  {
    ...
    description: [
      "Bánh không cay nên rất phù hợp với các bạn con nít",
      "Bánh được làm từ 100% khoai tây tự nhiên, lát bánh dày gấp 1.5 lần lát bánh thông thường, vị ngọt tự nhiên từ cá và tảo biển (không phải ngọt từ chất phụ gia), đặc biệt sản phẩm không thêm bột ngọt trong quá trình sản xuất nên rất an toàn với sức khỏe.",
    ],
    title: "Snack khoai tây Gokochi",
    taste: "Vị muối tự nhiên (65g)",
    energy: "558",
    calories: "315",
    caloriesPercent: "54%",
    totalFat: "35.0g",
    ...
    protein: "6.2g",
    ingredient:
      "Khoai tây 64,5 %, dầu thực vật, bột gia vị muối tự nhiên 3,5 % (muối (29,5 %), đường, maltodextrin, bột kem béo thực vật, đường dextrose, đạm thực vật thuỷ phân, bột chiết xuất nấm men, chất chống đông vón (INS 551), bột chiết xuất tảo bẹ, bột cá ngừ vằn, chất ổn định (INS 1422), dầu thực vật tinh luyện, chất điều vị (INS 951, INS 955)).",
  },
  {
    id: 2,
    ...
    description: [
      "Bánh không cay nên rất phù hợp với các bạn con nít.",
      "Bánh được làm từ 100% khoai tây tự nhiên, lát bánh dày gấp 1.5 lần lát bánh thông thường, vị ngọt tự nhiên từ nấm vi sinh lên men (không phải ngọt từ chất phụ gia), đặc biệt sản phẩm không thêm bột ngọt trong quá trình sản xuất nên rất an toàn với sức khỏe. Nấm vi sinh lên men này là một trong những món ăn rất hay được sử dụng tại hầu hết các bữa ăn của người Nhật vì rất tốt cho sức khỏe.",
    ],
    title: "Snack khoai tây Gokochi",
    taste: "Vị muối tiêu đen (65g)",
    energy: "554",
    calories: "315",
    totalFat: "35.0g",
    totalFatPercent: "54%",
  ...
  },
  {
    ...
    description: [
      "Bánh không cay nên rất phù hợp với các bạn con nít.",
      "Bánh được làm từ 100% khoai tây tự nhiên, lát bánh dày gấp 1.5 lần lát bánh thông thường, vị ngọt tự nhiên từ rong biển và nấm vi sinh lên men (không phải ngọt từ chất phụ gia), đặc biệt sản phẩm không thêm bột ngọt trong quá trình sản xuất nên rất an toàn với sức khỏe. Nấm vi sinh lên men này là một trong những món ăn rất hay được sử dụng tại hầu hết các bữa ăn của người Nhật vì rất tốt cho sức khỏe.",
    ],
    title: "Snack khoai tây Gokochi",
    taste: "Vị rong biển (65g)",
    energy: "555",
    calories: "315",
    totalFat: "35.0g",
    totalFatPercent: "54%",
